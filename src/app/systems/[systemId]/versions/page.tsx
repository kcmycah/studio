        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-headline text-4xl font-bold">{system?.name || "System"} History</h1>
                <p className="text-muted-foreground text-lg">Track accessibility performance across versions.</p>
              </div>
            </div>
          </div>
          <Button 

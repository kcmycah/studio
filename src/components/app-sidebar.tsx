    ...
    <aside className="fixed left-0 top-0 hidden h-full w-[260px] flex-col border-r bg-card md:flex z-50">
      <div className="flex h-16 items-center px-6 border-b">
        <Link href="/dashboard" className="flex items-center gap-2">
          ...
          <span className="text-lg font-black tracking-tight text-foreground">DISA Audit</span>
        </Link>
      </div>
      ...
      <div className="p-4 border-t">
        <Button 
          variant="ghost" 
          className="w-full justify-start text-muted-foreground hover:text-destructive hover:bg-destructive/5 font-bold"
